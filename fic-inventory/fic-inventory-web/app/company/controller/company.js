 ...
 */
'use strict';
angular.module('app.controller').controller('companyController', [ '$scope', 'CompanyServices', 'TypeAddressServices','$compile', function($scope, CompanyServices, TypeAddressServices,$compile) {
    ...
    $scope.showdiv = function(){
    	var compiledeHTML = $compile("<div company ></div>")($scope);
    	$("#d").empty();	
