...
public class OperationsWS {
	...
	public Response saveOperations(OperationsDTO operationsDTO){
		...
		try{
			if((operationsDTO!=null && operationsDTO.getProviderId()!=null && operationsDTO.getCompanyId()!=null) 
					&& (operationsDTO.getMovementTypeId()!=null && operationsDTO.getProductId()!=null)
					&& (operationsDTO.getStatusId()!=null && operationsDTO.getTimeUnitId()!=null)
					&& operationsDTO.getStocks()!=null){
